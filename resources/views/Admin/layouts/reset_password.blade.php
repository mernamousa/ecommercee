...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">@lang('leftsidebar.Reset Password')</p>
    ...
    <form action="{{url('admin/doResetPass')}}" method="post">
      {{ csrf_field() }}
      ...
      <div class="form-group has-feedback">
        <input name="confirmPassword" type="password" class="form-control" placeholder="@lang('leftsidebar.Confirm Password')">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="row">
