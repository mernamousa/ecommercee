...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="{{url('admin/check_verify_code')}}" method="post">
      {{ csrf_field() }}
      <div class="form-group has-feedback">
        <input name="verify_code" type="number" class="form-control" for="verify_code" placeholder=" Verify code" maxlength=4>
