...
<div class="login-box">
   <div class="login-box-body">
      <p class="login-box-msg">@lang('trans.Sign In')</p>
       @if($errors->all() !== null)
      ...
      <form action="{{url('doLogin')}}" method="post">
         ...
         <div class="form-group has-feedback">
            <input name="email" type="text" class="form-control" placeholder="@lang('trans.email')">
         ...
         <div class="row">
            <div class="col-xs-8">
               <a href="{{url('forgetPass')}}">@lang('trans.I forgot my password')</a><br>
            </div>
            <div class="col-xs-8">
               <a href="{{url('register')}}">@lang('trans.I dont have account')</a><br>
            </div>
            <br>
            <br>
            <!-- /.col -->
            <div class="col-xs-4">
               <button type="submit" class="btn btn-primary btn-block btn-flat btn-lg">@lang('trans.Sign In')</button>
            </div>
            <!-- /.col -->
         </div>
      </form>
