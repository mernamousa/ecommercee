...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">@lang('trans.Enter Code')</p>
    ...
    <form action="{{url('check_verify_code')}}" method="post">
      {{ csrf_field() }}
      <div class="form-group has-feedback">
        <input name="verify_code" type="number" class="form-control" for="verify_code" placeholder="@lang('trans.Enter Code')" maxlength=4>
      ...
      <div class="row">
         <div class="col-xs-8">
            <a href="{{url('login')}}">@lang('trans.Login Page')</a><br>
         </div>
        <!-- /.col -->
         <div class="col-xs-4">
            <button type="submit" class="btn btn-primary btn-block btn-flat">@lang('trans.Send')</button>
         </div>
         <!-- /.col -->
      </div>
    </form>
