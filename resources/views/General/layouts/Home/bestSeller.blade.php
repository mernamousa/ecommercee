         ...
         <div id="main_slider" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <h1 class="fashion_taital">@lang('trans.Best Selles Items')</h1>
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <p class="price_text">@lang('trans.Price')  <span style="color: #262626;">{{$item->itemPrice}}</span>
                                    @if($item->itemDiscount > 0)
                                    @lang('trans.discount') <span style="color: #262626;">{{$item->itemDiscount}}</span>

                                       @if($item->discountType == 'percent')
                                       @lang('trans.final')  <span style="color: #262626;">{{$item->itemPrice - ($item->itemDiscount/100 * $item->itemPrice)}}</span>
                                       @else
                                      @lang('trans.new Price')  <span style="color: #262626;">{{$item->itemPrice - $item->itemDiscount}}</span>
